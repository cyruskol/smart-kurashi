  ...
  return (
    <div style={{ background: '#fff', borderRadius: '8px', padding: '40px', border: '1px solid #E7E5E4' }}>
      ...
      <form action="/api/contact" method="POST" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        <div>
          <label htmlFor="name" style={{ display: 'block', fontSize: '14px', fontWeight: 600, color: '#0F172A', marginBottom: '6px' }}>お名前 <span style={{ color: '#8F4A24' }}>*</span></label>
        ...
        <div>
          <label htmlFor="email" style={{ display: 'block', fontSize: '14px', fontWeight: 600, color: '#0F172A', marginBottom: '6px' }}>メールアドレス <span style={{ color: '#8F4A24' }}>*</span></label>
        ...
        <div>
          <label htmlFor="message" style={{ display: 'block', fontSize: '14px', fontWeight: 600, color: '#0F172A', marginBottom: '6px' }}>お問い合わせ内容 <span style={{ color: '#8F4A24' }}>*</span></label>
